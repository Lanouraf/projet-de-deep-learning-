...
def plot_batch():
    """
    This function loads the data from the file and plots a comparison graph between different models.
    ...
    plot_compare(all_losses_vanilla, all_losses_bn, legend_a="Vanilla LeNet-5", legend_b="LeNet-5 with BatchNorm", save_to="result_plot_batch/Vanilla_vs_BatchNorm")
